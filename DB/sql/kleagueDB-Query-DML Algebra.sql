...
SELECT 	TEAM_NAME, STADIUM_ID, STADIUM_NAME 	/* 공통되는 애츠리뷰트가 STADIUM_ID, ADDRESS, DDD, TEL 네 개가 있음. */ 
...
SELECT 	TEAM_NAME, STADIUM_ID, STADIUM_NAME 	/* 공통되는 애츠리뷰트는 STADIUM_ID만 존재 */ 
